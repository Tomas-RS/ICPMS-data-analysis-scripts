#Simple script for ICP-MS data analysis of iron (single metal, no drift adjust) 
...
#Convert Fe and In values from characters to numeric using as.numeric function.
...
plot(Iron_blanks$Sequence_position, Iron_blanks$Z02_Scadjust, 
...
Iron_analysis$Z04_Fe_blankadjust <- Iron_analysis$Z02_Scadjust - mean(Iron_blanks[["Z02_Scadjust"]])
...
Iron_detectionlimit_ppb <- (3 * sd(Iron_blanks[["Z02_Scadjust"]])) / coef(Iron_stdplot)[2]
