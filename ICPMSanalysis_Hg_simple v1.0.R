...
#STEP FOUR: Continue Hg analysis by checking for baseline drift using 1 ppb standards but do not apply
...
Mercury_analysis$Z04_Hg_blankadjust <- Mercury_analysis$Z02_Iradjust - mean(Mercury_blanks[["Z02_Iradjust"]])
