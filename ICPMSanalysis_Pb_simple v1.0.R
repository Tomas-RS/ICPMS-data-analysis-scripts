...
#STEP FOUR: Continue Pb analysis by checking for baseline drift using 1 ppb standards but do not adjust
...
Lead_analysis$Z04_Pb_blankadjust <- Lead_analysis$Z02_Iradjust - mean(Lead_blanks[["Z02_Iradjust"]])
